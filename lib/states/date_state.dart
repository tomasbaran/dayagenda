...
class DateState {
  ...
  final isSelectedDateTodayForLoggedUser = ValueNotifier<bool>(true);
  ...
  selecteNewDate(DateTime newDateTime) {
    ...
    isSelectedDateTodayForLoggedUser.value = checkIfSelectedDateIsToday() && checkIfCurrentAgendaIsOfLoggedInUser();

    if (isSelectedDateTodayForLoggedUser.value) {
