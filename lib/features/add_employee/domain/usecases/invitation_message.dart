...
class InvitationMessage {
  static String call(Employee employee) =>
      'Buenos días! Vamos a probar una herramienta para aumentar la productividad. Favor de registrarse acá: $kDayagendaUrl/#/register_employee/${employee.tmpId}. Gracias de antemano. Saludos!';
}
