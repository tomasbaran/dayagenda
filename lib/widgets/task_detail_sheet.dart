            ...
            child: TextButton(
              ...
              onPressed: () {
                widget.sheetType == SheetType.newTask
                    ? listState.addTaskToList(taskState.selectedTask.value, dateList: dateState.selectedDate.value)
                  ...
                  final calendarValues = taskState.selectedTask.value.isCompleted
                      ...
                      : await showCalendarDatePicker2Dialog(
                          ...
                          config: CalendarDatePicker2WithActionButtonsConfig(
                            ...
                            selectedDayHighlightColor: kThemeColor4,
                            buttonPadding: const EdgeInsets.all(16),
                            cancelButtonTextStyle: const TextStyle(fontWeight: FontWeight.w500, color: kThemeColor9),
                            firstDayOfWeek: 0,
                            dayTextStyle: const TextStyle(color: kThemeColor12),
                            disableModePicker: true,
                            controlsTextStyle: const TextStyle(color: kThemeColor10, fontWeight: FontWeight.w800),
                            weekdayLabelTextStyle: const TextStyle(color: kThemeColor10, fontWeight: FontWeight.w800),
                            selectedDayTextStyle: const TextStyle(color: kThemeColor12, fontWeight: FontWeight.w700),
